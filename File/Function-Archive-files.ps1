...
Function ArchiveFiles
{
    ...
    foreach ($file in $Files)
    {
        ...
        Write-Output "Le fichier $fileName date du $FileLastwriteAccess.  C'est plus vieux que le max de : $DayForArchive jours. il doit être archivé" -ForegroundColor Green
        ...
        Write-Output "le fichier d'archive sera $ArchiveCible pour $file" -ForegroundColor Green
        ...
        Write-Output "le fichier $File a été archivé puis supprimé" -ForegroundColor Green
