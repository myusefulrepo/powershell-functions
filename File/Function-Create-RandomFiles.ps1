...
.EXAMPLE
   .\Add-File.ps1 -totalsize 50MB -NumberOfFiles 13 -Path C:\Users\Svangulick\

   Will generate randonmly 13 files for a total of 50mb in the path c:\users\svangulick\

.EXAMPLE
   .\Add-File.ps1 -totalsize 5GB -NumberOfFiles 3 -Path C:\Users\Svangulick\
...
#>
        ...
        function Add-FileName
        {
            ...
            process
            {
                ...
                switch ($filesType)
                {
                    "Multimedia"
                    {
                        $extension = $MultimediaExtensions | Get-Random
                    }
                    "Office"
                    {
                        $extension = $OfficeExtensions | Get-Random
                    }
                    default
                    {
    ...
    process
    {
        ...
        while ($TotalFileSize -lt $TotalSize)
        {
            ...
            $FileName = Add-FileName -filesType $filesType
